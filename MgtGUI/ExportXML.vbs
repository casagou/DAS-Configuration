...
argUserName	= "engineer" 'GetArg ("UserName")
argPassword	= "thehelp" 'GetArg ("Password")
...
'****************************************************************************** 
'**** Update Print Server Header and Footer
'****************************************************************************** 
' Establish the connection to the Print Server
Set app = CreateObject ("PrintServer.Output")


app.EnableEscape "c", "Test Cell"
app.EnableEscape "T", "Engine Type"
app.EnableEscape "E", "Engine Standard"
app.EnableEscape "C", "Customer"
app.EnableEscape "I", "Configuration ID"
app.EscapeValue ("c") = Configuration.TestCell
app.EscapeValue ("T") = argEngineType
app.EscapeValue ("E") = Configuration.EngineStandard
app.EscapeValue ("C") = Configuration.Customer
app.EscapeValue ("I") = argConfigID
